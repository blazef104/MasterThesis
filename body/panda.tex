...
The table in Figure \ref{fig:frcmp} provides an overview of the other frameworks, similar to PANDA, that are available. 

\todo{Finish this off, add some context on the other frameworks, not only the one in the table but also other based on QEMU for example decaf is all based on tainting}
