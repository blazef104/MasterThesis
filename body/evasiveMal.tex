...
Different level of analysis requires different amount of visibility and interaction of the analyst with the environment. In particular, in order to extract as many information as possible from an analyzed system it is necessary to have complete control of every single component.

\todo{decaf paper on whole system emulation here}
