...
\begin{figure}[htp]
    \centering
    \subfloat[\centering vanilla system]{{\includegraphics[width=0.4\linewidth]{images/t2.png} }}%
    \subfloat[\centering plugin]{{\includegraphics[width=0.3734\linewidth]{images/t1.png} }}%
...
% ugly workaround to get the text after the image
\begin{figure}[h!]
